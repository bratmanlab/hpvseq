...
include { GATK3_DEPTHOFCOVERAGE as COVERAGE_QUANTIFICATION  } from '../../../modules/local/gatk3/depthofcoverage'

workflow COVERAGE_QUANTIFICATION_F2 {
    take:
    ...
    emit:
    summary      = COVERAGE_QUANTIFICATION.out.summary 
}
